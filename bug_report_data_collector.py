...
# def get_bug_reports_with_stack_traces(path):
#     bug_reports = []
...
#                         # # Convert JSON content to a string to apply regex and look for stack traces
...
#     bug_reports = get_bug_reports_with_stack_traces(REPO_PATH)

#     if bug_reports:
#         print(f"Found {len(bug_reports)} JSON files with stack traces.")

#         # Save the results to a JSON file
#         with open("bug_reports_with_stack_traces.json", "w") as f:
