...
REPO_PATH = '/Users/fahim/Desktop/PhD/Projects/Pathidea_Data/bug_reports/MAPREDUCE'
...
def main():
    ...
    if bug_reports:
        ...
        with open("bug_reports/bug_reports_MAPREDUCE.json", "w", encoding='utf-8') as f:
            json.dump(bug_reports, f, indent=4)
            # for report in bug_reports:
            #     f.write(f"{report['filename']} - {report['path']}\n")
        
        print("Bug reports with stack traces saved to 'bug_reports_MAPREDUCE.json'.")
    else:
